 ...
 *
 * https://gist.github.com/AllanHasegawa/d1e251744275d16af45484b0dbac37ee
 *
 * based on: https://gist.github.com/RomansBermans/6f3836188427fbd3b1efcf7e6418f06d
 * Fancy ID generator that creates 20-character string identifiers with the following properties:
 *
 * 1. They're based on timestamp so that they sort *after* any existing ids.
 * 2. They contain 72-bits of random data after the timestamp so that IDs won't collide with other IDs.
